...
dir=	#la variabile f serve per memorizzare il parametro che rappresenta il nome relativo semplice del file (primo o secondo parametro a seconda dei casi)
case $# in
...
case $dir in
*/*) echo Errore: $dir non in forma relativa semplice 
     exit 4;;
*) ;;
esac
...
sh cercadir.sh $d $dir	#invocazione del secondo file comandi (che e' quello RICORSIVO e fa in questo caso tutto il 'lavoro'!)
